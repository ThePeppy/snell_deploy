...
forceCheckVersions(){
    ...
    if [[ -n "$web_v4" ]]; then
        ...
        case $? in
            ...
            2) echo -e "${Info} v4 版本状态: 脚本内置版本比网页版本更新" ;;
            3) echo -e "${Tip} v4 版本状态: 网页版本比脚本内置版本更新" ;;
        esac
    fi
    ...
    if [[ -n "$web_v5" ]]; then
        ...
        case $? in
            4) echo -e "${Info} v5 版本状态: 脚本内置版本与网页版本相同" ;;
            5) echo -e "${Info} v5 版本状态: 脚本内置版本比网页版本更新" ;;
            6) echo -e "${Tip} v5 版本状态: 网页版本比脚本内置版本更新" ;;
        esac
    fi
